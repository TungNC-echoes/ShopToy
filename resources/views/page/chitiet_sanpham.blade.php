                ...
                <div class="col-sm-9">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            ?>
                            <img src="{{URL::to('source/image/product/'.$image_item)}}" alt="">
                        </div>
                        <div class="col-sm-8">
                                    ...
                                    <div class="single-item">
                                        ...
                                        <div class="single-item-header">
                                            <?php
                                                $image = $sptt->image;
                                            ?>
                                            <a href="{{route('chitietsanpham', $sptt->id)}}"><img src="{{URL::to('source/image/product/'.$image)}}" height="150px" width="250px" alt=""></a>
                                        </div>
                                        <<div class="single-item-body">
