                                ...
                                <div class="col-sm-4">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            @if(!empty($sp->promotion_price))
                                                <div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
                                            @endif
                                            <?php
                                                $image = $sp->image;
                                            ?>
                                            <a href="{{route('chitietsanpham', $sp->id)}}"><img src="{{asset('source/image/product/'.$image)}}" alt="" height="250px"></a>
                                        </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="single-item">
                                        <div class="single-item-header">
                                            ...
                                            $image = $sp->image;
                                            ?>
                                            <a href="{{route('loaisanpham', $sp->id)}}"><img src="{{URL::to('source/image/product/'.$image)}}" alt="" height="250px"></a>
                                        </div>
                                        <div class="single-item-body">
                                            <p class="single-item-title">{{$sp->name}}</p>
                                            @if($sp->promotion_price!=0)
